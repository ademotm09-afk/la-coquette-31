...
import { ChevronDown, ChevronLeft, ChevronRight, Filter, Heart, Mail, MapPin, Menu, MessageCircle, Phone, Search, ShoppingBag, SlidersHorizontal, Sparkles, Truck, X } from "lucide-react";
    ...
    <div dir={isRtl ? "rtl" : "ltr"} className="min-h-screen overflow-x-clip bg-[#faf8f5] text-[#3e2723]">
      ...
      <footer className="bg-[#fffdfa] px-5 pb-28 pt-12 sm:pb-10 sm:pt-16">
        <div className="mx-auto grid max-w-[1300px] gap-10 sm:grid-cols-3 sm:items-start">
          ...
          <div><p className="text-[10px] font-bold uppercase tracking-[.16em] text-[#8d7568]">{t("follow")}</p><div className="mt-4 flex flex-col gap-3 text-xs text-[#6d574c]"><a href="tel:+213541442571" className="flex items-center gap-2"><Phone size={14} /> 0541442571</a><a href="mailto:web.automation.310@gmail.com" className="flex items-center gap-2"><Mail size={14} /> web.automation.310@gmail.com</a><div className="mt-2 flex gap-2"><a href="https://www.instagram.com/lacoquette.brand" target="_blank" rel="noreferrer" aria-label="Instagram" className="grid size-11 place-items-center rounded-full border border-[#ded2c8] hover:bg-[#efe6de]"><Instagram size={17} /></a><a href="https://www.facebook.com/share/1BRYR8uzsZ/?mibextid=wwXIfr" target="_blank" rel="noreferrer" aria-label="Facebook" className="grid size-11 place-items-center rounded-full border border-[#ded2c8] hover:bg-[#efe6de]"><Facebook size={17} /></a><a href="https://wa.me/213541442571?text=Bonjour%20La%20Coquette" target="_blank" rel="noreferrer" aria-label="WhatsApp" className="grid size-11 place-items-center rounded-full border border-[#ded2c8] hover:bg-[#efe6de]"><MessageCircle size={17} /></a></div></div></div>

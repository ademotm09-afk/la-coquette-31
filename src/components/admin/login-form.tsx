...
export function LoginForm() {
  ...
  const [password, setPassword] = useState("Coquette2026!");
  ...
  return (
    <form onSubmit={submit} className="mt-9 space-y-4">
      ...
      <p className="pt-2 text-center text-[10px] leading-5 text-[#9b897e]">Accès réservé à l’équipe La Coquette.<br />Les identifiants de démonstration sont préremplis.</p>
    </form>
  );
}
